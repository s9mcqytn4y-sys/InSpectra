-- =========================================================
-- RECREATE CHECKSHEET PART PICKER VIEW
-- Recreates the view dropped by cascade in previous migration.
-- =========================================================
...
grant select on public.v_checksheet_part_picker to anon, authenticated;
